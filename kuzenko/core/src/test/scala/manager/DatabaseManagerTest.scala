...
import domain.Type.{Char, CharInv, Integer, Real, String}
import domain.{Column, Row, Table}
import org.junit.Test
import utils.Parameters.{dbLocation, tableExtension}
import utils.{DBFileUtils, ScalaFileUtils}
